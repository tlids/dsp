...
>> Using Bayes' Theorem, the answer is 5/17.  
...
>> One major difference is that, while Bayesian statistics can provide an exact probability for an unknown parameter, frequentist statistics' result is not a probability, rather, it is a "true or false" conclusion from the significance test with certain confidence interval.
